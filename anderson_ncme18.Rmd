...
Publicly available data reporting on the percentage of students scoring in each PLC
Following the evaluation of $V_d$, we used the procedure to estimate Black-White achievement gaps for all schools in California, using coarsened data reported for the 2016-17 school year in both reading and mathematics. 
