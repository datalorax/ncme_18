...
Figure 1 displays the relation between $V_c$ and $D$ both in terms of the bivariate relation and the distribution of differences with respect to $V$. The vertical line on the histogram indicates the mean of the differences. Note that it was slightly negative ($M =$ `r round(mean(es_c$diff, na.rm = TRUE),2)`), indicating that, on average for this sample, $V$ represented a slightly lower estimate of the effect size.
